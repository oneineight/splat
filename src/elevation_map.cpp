...
double ElevationMap::ElevationAngle(Path &path, const Site &source, const Site &destination) const
{
...
double ElevationMap::ElevationAngle2(Path &path, const Site &source, const Site &destination, double er) const
{
    /* This function returns the angle of elevation (in degrees)
